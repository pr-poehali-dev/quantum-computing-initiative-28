...
const philosophyItems = [
  ...
  },
  {
    ...
    description:
      "На все работы и комплектующие даем гарантию! (срок гарантии зависит от вида работ и комплектующих). Если что-то не так — устраним БЕСПЛАТНО.",
  },
  {
    title: "Уважение к вашему времени",
    description: "Большинство работ выполняем за 30–40 минут. Вы можете подождать прямо в мастерской, в комфортной клиентской зоне за чашечкой чая или кофе, а если ремонт продлится дольше, тогда можете оставить авто и забрать когда удобно.",
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          <div className="lg:sticky lg:top-32 lg:self-start">
            ...
            <div className="relative hidden lg:block">
              <img
                src="https://cdn.poehali.dev/projects/f962568d-c5ff-4b77-995c-c770a5661c80/bucket/20638d67-6ffc-4dda-a243-ff3300cc6f3f.jpeg"
                alt="ПроВыхлоп — мастерская по ремонту выхлопных систем"
                className="opacity-90 relative z-10 w-full rounded"
              />
            </div>
          </div>
