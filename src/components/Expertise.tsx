...
const expertiseAreas = [
  {
    ...
    description: "Работаем со всеми типами глушителей — от бюджетных до спортивных прямоточных систем.",
    icon: "Wrench",
  },
  {
    title: "Сварка выхлопных труб",
    description: "Устраняем трещины, прогары и коррозию в любом месте выхлопного тракта.",
    icon: "Flame",
  },
  {
    title: "Катализаторы и резонаторы",
    description: "Замена прогоревших резонаторов. Проверка катализатора на противодавление. Эндоскопия катализатора. Удаление или замена катализатора.",
    icon: "ShieldCheck",
  },
  {
