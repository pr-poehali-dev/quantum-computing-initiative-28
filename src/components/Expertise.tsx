...
const expertiseAreas = [
  ...
  },
  {
    ...
    description: "Устраняем трещины, прогары и коррозию в любом месте выхлопного тракта. Перевариваем гофры и меняем фланцы. Замена кронштейнов и крепежей (резинок) выхлопной трассы.",
    icon: "Flame",
  },
  {
    title: "Катализаторы",
