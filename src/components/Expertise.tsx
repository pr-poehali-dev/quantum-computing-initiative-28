...
const expertiseAreas = [
  {
    ...
    description: "При необходимости заменим неисправные детали или проведем сварочные работы. Если ремонт оказывается нецелесообразным, мы поможем подобрать и установить новый глушитель или резонатор, соответствующий вашему автомобилю.",
    icon: "Wrench",
  },
  {
  ...
  {
    title: "Изготовление выхлопной трассы",
    description: "В случае отсутствия заводских решений, изготавливаем выхлопные системы на все легковые автомобили и кроссоверы.",
    icon: "Settings",
  },
]
