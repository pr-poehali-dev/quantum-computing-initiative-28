...
const faqs = [
  {
    ...
    answer:
      "Стоимость зависит от объёма работ: сварка трещины от 1 000 руб., замена глушителя от 2500 руб., замена гофры от 3500, удаление катализатора от 6 000 руб. Более точную цену называем после консультации по телефону или после бесплатной диагностики.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Можно приехать без записи — примем в порядке живой очереди. Но лучше позвонить заранее и записаться.",
  },
  {
