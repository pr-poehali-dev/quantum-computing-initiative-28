...
const faqs = [
  {
    ...
    answer:
      "Стоимость зависит от объёма работ: сварка трещины от 1 500 руб., замена глушителя от 3 000 руб., замена катализатора от 8 000 руб. Точную цену называем после осмотра автомобиля — это бесплатно.",
  },
  {
    question: "Как долго делается ремонт?",
    answer:
      "Большинство работ занимает от 1 до 3 часов. Сварка трубы — 30–60 минут. Замена глушителя — 1–2 часа. Сложные работы с изготовлением под заказ — от 1 дня. Сообщим точный срок на диагностике.",
  },
  {
